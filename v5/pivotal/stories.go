...
type Story struct {
	...
	CycleTimeDetails *CycleTimeDetails `json:"cycle_time_details,omitempty"`
}

type CycleTimeDetails struct {
	TotalCycleTime int    `json:"total_cycle_time,omitempty"`
	...
	DeliveredTime  int    `json:"delivered_time,omitempty"`
	DeliveredCount int    `json:"delivered_count,omitempty"`
	RejectedTime   int    `json:"rejected_time,omitempty"`
...
func (service *StoryService) List(projectId int, filter, fields string) ([]*Story, error) {
...
func newStoriesRequestFunc(client *Client, projectId int, filter, fields string) func() *http.Request {
...
func (service *StoryService) Iterate(projectId int, filter, fields string) (c *StoryCursor, err error) {
	reqFunc := newStoriesRequestFunc(service.client, projectId, filter, fields)
